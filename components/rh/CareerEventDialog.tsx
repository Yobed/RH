...
export function CareerEventDialog({ employeeId, companyId }: { employeeId: string; companyId: string }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger
        render={
          <Button variant="outline" size="sm" className="border-slate-200 hover:bg-[#2563eb]/10 hover:text-[#2563eb] hover:border-[#2563eb]/30 transition-all">
            <PlusIcon className="h-4 w-4 mr-2 text-[#2563eb]" />
      ...
      <DialogContent className="sm:max-w-[425px] rounded-2xl bg-white border-slate-200 shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-4">
          <div className="space-y-2">
            ...
            <select
              {...register("event_type")}
              className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm focus:ring-2 focus:ring-[#2563eb] focus:outline-none transition-all"
            >
          ...
          <div className="space-y-2">
            ...
            <Input type="date" {...register("date_event")} className="rounded-xl focus-visible:ring-[#2563eb]" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className="rounded-xl focus-visible:ring-[#2563eb]"
            />
          ...
          <div className="pt-4 flex justify-end">
            <Button type="submit" disabled={isSubmitting} className="rounded-xl bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-semibold shadow-md shadow-[#2563eb]/20 px-6">
