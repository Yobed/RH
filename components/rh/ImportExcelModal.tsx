        ...
        <div className="overflow-y-auto flex-1">
              ...
              >
                ...
                {parsing ? (
                  <div className="flex flex-col items-center gap-2">
                    <span className="h-6 w-6 rounded-full border-2 border-slate-400 border-t-transparent animate-spin" />
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                      ...
                      <span className="text-[oklch(0.38_0.10_252)] font-medium">cliquez pour sélectionner</span>
                    </p>
          ...
          {state === "importing" && (
            <div className="p-12 flex flex-col items-center gap-4">
              <span className="h-10 w-10 rounded-full border-4 border-slate-200 border-t-[oklch(0.78_0.13_73)] animate-spin" />
