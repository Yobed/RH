        ...
        return (
          <div
            ...
            className={`flex items-center justify-between gap-4 rounded-lg border px-4 py-3 transition-colors ${
              isCurrent ? "border-indigo-500/40 bg-indigo-500/5" : "border-border bg-card"
            }`}
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-sm font-medium text-foreground truncate">
                  {v.file_name}
                  {isCurrent && <span className="ml-2 text-[10px] bg-indigo-500/20 text-indigo-400 px-1.5 py-0.5 rounded-full">actuelle</span>}
                </p>
