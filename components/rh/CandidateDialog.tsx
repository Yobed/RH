        ...
        <div className="bg-white/80 backdrop-blur-xl border border-white/40 shadow-2xl rounded-[2rem] overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <DialogHeader className="p-8 pb-4">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-2xl bg-emerald-900/5 text-emerald-900">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input 
                    ...
                    className="rounded-xl bg-white/50 border-slate-200 h-11"
                  />
                  {errors.full_name && (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="rounded-xl bg-white/50 border-slate-200 min-h-[100px] focus:bg-white transition-all"
                />
              </div>
            </div>
