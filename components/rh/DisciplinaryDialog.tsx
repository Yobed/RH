          ...
          <form onSubmit={onSubmit} className="px-8 pb-8 flex-1 overflow-y-auto space-y-8 scrollbar-hide">
              ...
              <div className="space-y-4">
                  ...
                  {deadline && (
                    ...
                    >
                      <WarningCircle weight="fill" className={`h-4 w-4 shrink-0 mt-0.5 ${
                        deadline.level === "danger" ? "text-rose-600" : deadline.level === "warn" ? "text-amber-600" : "text-[#0d9488]"
                      }`} />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input type="date" id="date_convocation" name="date_convocation" className="rounded-xl h-11 focus-visible:ring-[#0d9488]" />
                  </div>
                  <div>
                    <label className={labelClass}>
                      <Calendar weight="duotone" />
                    ...
                    <Input type="date" id="date_audition" name="date_audition" className="rounded-xl h-11 focus-visible:ring-[#0d9488]" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="rounded-xl bg-white border-slate-200 min-h-[100px] focus-visible:ring-[#0d9488]"
                />
            ...
            <DialogFooter className="pt-4 sticky bottom-0 bg-white -mx-8 px-8 mt-4 border-t border-slate-100 shrink-0 flex items-center justify-end gap-3">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="h-12 px-6 rounded-2xl bg-[#0d9488] hover:bg-[#0f766e] text-white font-bold shadow-lg shadow-[#0d9488]/20 transition-all hover:scale-[1.01] active:scale-[0.99]"
              >
