...
const COLORS = ['#0d9488', '#0F172A', '#475569', '#0f766e', '#CBD5E1', '#E2E8F0'];
const GENDER_COLORS = ['#0F172A', '#0d9488'];

export function DashboardCharts({ deptData, genderData }: ChartProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      {/* Répartition par Département */}
      <div className="group relative overflow-hidden bg-white/90 backdrop-blur-md dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-7 shadow-lg shadow-slate-200/40 dark:shadow-none hover:shadow-2xl hover:shadow-[#0d9488]/5 transition-all duration-300">
