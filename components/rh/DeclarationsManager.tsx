        ...
        <div className="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-[1fr_1fr_auto] gap-3 items-end">
          <div>
            ...
            <select
              ...
              className="mt-1 h-9 w-full rounded-md border border-slate-200 bg-white px-3 text-sm text-slate-700 focus:outline-none focus:border-[#0d9488] focus:ring-1 focus:ring-[#0d9488]/20 transition-all"
            >
          ...
          <div>
            ...
            {isMonthlyKind ? (
              ...
              <input
                ...
                className="mt-1 h-9 w-full rounded-md border border-slate-200 bg-white px-3 text-sm text-slate-700 tabular-nums focus:outline-none focus:border-[#0d9488] focus:ring-1 focus:ring-[#0d9488]/20 transition-all"
              />
            )}
          </div>
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              ...
              disabled={generating || previewing}
              className="h-9 inline-flex items-center justify-center gap-2 rounded-md bg-[#0d9488] hover:bg-[#0f766e] border-0 px-4 text-sm font-medium text-white disabled:opacity-50 transition-colors"
            >
            ...
            <li key={r.id} className="p-4">
              ...
              {r.statut !== "soumis" && (
                <button
                  onClick={() => onMarkSubmitted(r.id, kindClass)}
                  disabled={submittingId === r.id}
                  className="mt-3 w-full text-xs px-3 h-8 rounded-md bg-[#0d9488] hover:bg-[#0f766e] border-0 text-white disabled:opacity-50 transition-colors"
                >
...
function SummaryCell({
  ...
  const valueColor =
    accent === "primary" ? "text-[#0d9488] font-semibold" :
