...
export function ParcoursGuidesWidget() {
  ...
  const PARCOURS = [
    ...
    },
    {
      ...
      icon: Calculator,
      badge: "Mensuel",
      badgeColor: "bg-[#ee7f03]/10 text-[#ee7f03] border-[#ee7f03]/30",
      cta: "Lancer la paie",
      accent: "from-[#ee7f03]/20 via-[#ee7f03]/5 to-transparent",
    },
    {
      id: "conges",
      ...
      <div className="rounded-3xl border-2 border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden p-6 transition-all">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 pb-4 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-2xl bg-[#ee7f03] text-white flex items-center justify-center shadow-lg shadow-[#ee7f03]/25 shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-700 dark:text-amber-300 text-[10px] font-bold uppercase tracking-wider border border-amber-500/20">
                  Procédures Clés
                </span>
              </div>
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto text-[11px] font-bold text-slate-400">
            <span>Détecter</span>
            <ChevronRight className="h-3 w-3 text-[#ee7f03]" />
          ...
          {PARCOURS.map((item) => {
            ...
            return (
              <div
                ...
                className="group relative rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 p-4 hover:bg-white dark:hover:bg-slate-800 hover:border-[#ee7f03]/60 hover:shadow-xl hover:shadow-[#ee7f03]/5 transition-all duration-300 cursor-pointer flex flex-col justify-between"
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div className="h-10 w-10 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 group-hover:border-[#ee7f03]/50 group-hover:bg-[#ee7f03] group-hover:text-white flex items-center justify-center text-slate-700 dark:text-slate-200 transition-colors shadow-2xs">
                  ...
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-[#ee7f03] transition-colors">
                    {item.title}
                  </h4>
                ...
                <div className="mt-4 pt-3 border-t border-slate-200/60 dark:border-slate-700/60 flex items-center justify-between text-xs font-bold text-[#ee7f03] group-hover:translate-x-0.5 transition-transform">
                  <span>{item.cta}</span>
