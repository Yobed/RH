...
export function ParcoursGuidesWidget() {
  ...
  const PARCOURS = [
    ...
    },
    {
      ...
      cta: "Lancer la paie",
      accent: "from-[#059669]/20 via-[#059669]/5 to-transparent",
    },
    {
      id: "conges",
      ...
      <div className="rounded-3xl border-2 border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden p-6 transition-all">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 pb-4 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-2xl bg-[#059669] text-white flex items-center justify-center shadow-lg shadow-[#059669]/25 shrink-0">
          ...
          {PARCOURS.map((item) => {
            ...
            return (
              <div
                ...
                className="group relative rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 p-4 hover:bg-white dark:hover:bg-slate-800 hover:border-[#059669]/60 hover:shadow-xl hover:shadow-[#059669]/5 transition-all duration-300 cursor-pointer flex flex-col justify-between"
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div className="h-10 w-10 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 group-hover:border-[#059669]/50 group-hover:bg-[#059669] group-hover:text-white flex items-center justify-center text-slate-700 dark:text-slate-200 transition-colors shadow-2xs">
                  ...
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-[#059669] transition-colors">
                    {item.title}
                  </h4>
                ...
                <div className="mt-4 pt-3 border-t border-slate-200/60 dark:border-slate-700/60 flex items-center justify-between text-xs font-bold text-[#059669] group-hover:translate-x-0.5 transition-transform">
                  <span>{item.cta}</span>
