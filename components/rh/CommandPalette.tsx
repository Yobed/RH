                ...
                {items.map((cmd) => {
                  ...
                  return (
                    <Command.Item
                      ...
                      className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-700 dark:text-slate-300 cursor-pointer outline-none aria-selected:bg-[#ee7f03]/10 dark:aria-selected:bg-[#b35c00]/20 aria-selected:text-[#ee7f03] dark:aria-selected:text-[#f8d3a3] transition-colors"
                    >
                      <Icon
                        weight="duotone"
                        className="h-4 w-4 shrink-0 text-slate-400 aria-selected:text-[#ee7f03]"
                      />
