    ...
    <div className="space-y-5">
      ...
      {employees.length === 0 ? (
        ...
        <div className="bg-white border border-slate-100 rounded-2xl p-12 text-center">
          ...
          <button
            onClick={() => setShiftMgr(true)}
            className="inline-flex items-center gap-2 h-9 px-4 rounded-md bg-[#ee7f03] text-white text-sm font-medium hover:bg-[#d67002]"
          >
              ...
              <thead>
                <tr>
                  ...
                  {days.map(d => (
                    <th
                      key={d.toISOString()}
                      className={`border-b border-slate-200 px-2 py-3 text-center text-[10px] font-semibold uppercase tracking-widest min-w-[110px] ${isToday(d) ? "bg-[#ee7f03]/10 text-[#ee7f03]" : "bg-slate-50 text-slate-600"}`}
                    >
                ...
                {employees.map(emp => (
                  <tr key={emp.id} className="hover:bg-slate-50/40">
                    ...
                    {days.map(d => {
                      ...
                      return (
                        <td key={dateStr} className={`px-2 py-1.5 text-center border-r border-slate-50 ${isToday(d) ? "bg-[#ee7f03]/[0.06]" : ""}`}>
                          {shift ? (
                            <button
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <div className="space-y-3 border-t border-slate-100 pt-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full h-9 px-3 text-sm border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-[#f8d3a3]"
                />
              </div>
              <div>
            ...
            <button
              ...
              className="w-full h-9 inline-flex items-center justify-center gap-2 rounded-md bg-[#ee7f03] text-white text-sm font-medium hover:bg-[#d67002] disabled:opacity-50"
            >
              <Plus className="w-3.5 h-3.5" />
