      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8 sm:gap-10">
        ...
        <div className="space-y-5 max-w-3xl">
          <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-3">
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[11px] font-black uppercase tracking-wider bg-[#1e40af]/10 text-[#1e40af] dark:bg-[#1e40af]/20 dark:text-[#A87B9F] border border-[#1e40af]/20 shadow-xs backdrop-blur-md">
              <Clock className="h-3.5 w-3.5 text-[#1e40af]" />
              {dateLabel}
            </span>
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[11px] font-black uppercase tracking-wider bg-[#2563eb]/15 text-[#2563eb] border border-[#2563eb]/30 shadow-xs backdrop-blur-md">
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-3.5 pt-1">
            <div className="flex items-center gap-3 rounded-2xl border border-slate-200/90 bg-slate-50/90 dark:border-slate-800 dark:bg-slate-800/90 px-4.5 py-2.5 shadow-sm backdrop-blur-md hover:border-[#1e40af]/50 transition-all group cursor-pointer">
              ...
              <span className="text-sm font-black tabular-nums text-slate-900 dark:text-white group-hover:text-[#017E84] transition-colors">{totalActifs}</span>
            ...
            {congesEnAttente > 0 ? (
              <div className="flex items-center gap-3 rounded-2xl border border-amber-300/80 bg-amber-50 dark:border-amber-900/60 dark:bg-amber-950/50 px-4.5 py-2.5 shadow-sm backdrop-blur-md hover:border-[#2563eb] transition-all group cursor-pointer">
                <span className="text-sm font-black tabular-nums text-[#2563eb]">{congesEnAttente}</span>
                <span className="text-xs text-amber-950 dark:text-amber-300 font-bold">Demande(s) de Congé</span>
                <span className="px-1.5 py-0.5 rounded-md bg-[#2563eb] text-[10px] font-black text-white uppercase tracking-wider ml-1">À valider</span>
              </div>
            ) : (
        ...
        >
          ...
          <div className="relative flex items-center justify-center mb-5 group-hover:scale-105 transition-transform duration-300">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-[9px] text-slate-400 uppercase font-black tracking-widest mt-0.5">/ 100 PTS</span>
            </div>
          </div>
          ...
          <div className="mt-4 flex items-center justify-between pt-2">
            ...
            <button className="text-[11px] font-black text-slate-400 group-hover:text-[#2563eb] flex items-center gap-0.5 transition-colors">
