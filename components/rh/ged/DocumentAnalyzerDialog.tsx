      ...
      <div className="flex w-full h-full bg-white shadow-2xl flex-col">
        ...
        <header className="flex items-center justify-between gap-3 px-5 py-3 border-b border-slate-200 bg-slate-50/60 shrink-0">
          <div className="flex items-center gap-2 min-w-0">
            <div className="h-7 w-7 rounded-lg bg-[#ee7f03] flex items-center justify-center shrink-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Button
              ...
              disabled={analyzing}
              size="sm"
              className="gap-1.5 bg-gradient-to-br from-slate-600 to-[#ee7f03] hover:from-slate-700 hover:to-[#ee7f03] text-white shadow-sm"
            >
              {analyzing ? (
        ...
        <div className="flex-1 flex min-h-0">
          ...
          <section className="w-full lg:w-[46%] overflow-y-auto border-r border-slate-200 bg-white">
            <div className="p-5 space-y-5">
              {/* Bandeau IA */}
              <div className="rounded-xl border border-slate-100 bg-gradient-to-br from-slate-50 to-[#ee7f03]/10 p-4">
                <div className="flex items-start gap-3">
                  <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-slate-600 to-[#ee7f03] flex items-center justify-center shrink-0 shadow-sm">
              ...
              <div>
                <div className="flex items-center justify-between mb-2.5">
                  ...
                  {extracted?.type_document && (
                    <span className="inline-flex items-center rounded-full bg-[#ee7f03]/10 px-2 py-0.5 text-[10px] font-bold text-[#ee7f03] uppercase tracking-wide">
                      {extracted.type_document}
                    </span>
                  )}
                </div>
            ...
            {pdf ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-center p-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-4 inline-flex items-center gap-1.5 rounded-md bg-[#ee7f03] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#ee7f03]"
                >
                  <Download className="h-3.5 w-3.5" /> Télécharger
                </a>
              </div>
