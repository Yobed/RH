      ...
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <History className="h-4 w-4 text-[#ee7f03]" />
        ...
        <div className="rounded-2xl border border-[#ee7f03]/20 bg-[#ee7f03]/10 p-4 space-y-3">
          <div className="flex items-center justify-between">
            <p className="text-xs font-bold uppercase tracking-widest text-[#ee7f03]">
          ...
          <div
            ...
            className="cursor-pointer rounded-xl border-2 border-dashed border-[#ee7f03]/30 bg-white p-4 text-center hover:border-[#f6c68a] transition-colors"
          >
            {file ? (
          ...
          <Input
            ...
            className="bg-white border-[#ee7f03]/20 text-sm"
          />

          <Button
            onClick={handleUploadVersion}
            disabled={uploading || !file}
            className="w-full bg-[#ee7f03] hover:bg-[#ee7f03] text-white h-9 text-sm font-semibold"
          >
            {uploading ? (
              <>
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-xl border border-emerald-200 bg-emerald-50/40 p-3 flex items-center gap-3">
                ...
                <a
                  ...
                  className="p-2 rounded-lg text-slate-500 hover:text-[#ee7f03] hover:bg-white transition-colors"
                  title="Télécharger"
                >
                ...
                versions.map((v) => (
                  ...
                  >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 rounded-lg text-slate-400 hover:text-[#ee7f03] hover:bg-[#ee7f03]/10 transition-colors shrink-0"
