  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="h-11 px-5 rounded-xl font-semibold bg-[#FF8200] hover:bg-[#E06D00] text-white shadow-md shadow-[#FF8200]/20 transition-all gap-2 group">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3">
                 <div className="h-0.5 w-6 bg-[#FF8200] rounded-full" />
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="col-span-full">
                  ...
                  <select {...register("employee_id")} className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 focus:ring-2 focus:ring-[#FF8200] focus:outline-none transition-all">
                ...
                <div>
                  ...
                  <select {...register("type")} className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 focus:ring-2 focus:ring-[#FF8200] focus:outline-none transition-all">
                ...
                <div>
                  ...
                  <Input type="date" {...register("date_prevue")} className="mt-1.5 h-10 rounded-xl bg-white border-slate-200 font-medium focus-visible:ring-[#FF8200]" />
                </div>
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-1.5 h-10 rounded-xl bg-white border-slate-200 font-medium focus-visible:ring-[#FF8200]"
                />
                {errors.titre && (
            ...
            <section className="space-y-4 pt-4 border-t border-slate-100">
              ...
              <div>
                ...
                <select {...register("evaluateur_id")} className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 focus:ring-2 focus:ring-[#FF8200] focus:outline-none transition-all">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="mt-1.5 rounded-xl bg-white border-slate-200 focus-visible:ring-[#FF8200] min-h-[80px]"
                />
              </div>
            ...
            <div className="pt-4 border-t border-slate-100">
              ...
              <select {...register("statut")} className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 focus:ring-2 focus:ring-[#FF8200] focus:outline-none transition-all">
            ...
            <DialogFooter className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row gap-3">
               ...
               <Button type="submit" disabled={isSubmitting} className="rounded-xl font-semibold bg-[#FF8200] hover:bg-[#E06D00] text-white h-11 px-8 shadow-md shadow-[#FF8200]/20">
