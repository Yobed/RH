...
const BOX_DESCRIPTIONS: Record<string, { label: string, color: string, description: string }> = {
  ...
  '0-2': { label: 'Spécialiste', color: 'bg-[#ee7f03]', description: 'Haute expertise, potentiel de management limité.' },
  '1-1': { label: 'Core Talent', color: 'bg-[#f6c68a]', description: 'Professionnels en développement.' },
  '2-0': { label: 'Enigme', color: 'bg-[#f6c68a]', description: 'Haut potentiel mais performance instable.' },
