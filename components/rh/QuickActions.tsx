        ...
        {PRIMARY.map((a) => {
          ...
          return (
            <Link
              key={a.href}
              href={a.href}
              className="group flex flex-col gap-3 rounded-xl border border-slate-200/70 bg-slate-50/50 p-4 transition-all hover:-translate-y-0.5 hover:border-[#0d9488]/40 hover:bg-white hover:shadow-[0_10px_24px_-14px_rgba(13,148,136,0.45)] dark:border-slate-800 dark:bg-slate-800/40 dark:hover:bg-slate-800"
            >
              <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#0d9488] text-white shadow-sm transition-transform group-hover:scale-105">
              ...
              <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-[#0f766e] dark:text-[#2dd4bf]">
      ...
      <div className="grid grid-cols-1 gap-2 border-t border-slate-100 pt-3 dark:border-slate-800 sm:grid-cols-3">
        {SECONDARY.map((a) => {
          ...
          return (
            ...
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 transition-colors group-hover:text-[#0f766e] dark:border-slate-700 dark:bg-slate-900">
