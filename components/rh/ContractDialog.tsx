...
const selectClass =
  "w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ee7f03] focus-visible:border-[#ee7f03] disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 hover:border-slate-300 h-11";
      ...
      <DialogTrigger asChild>
        {isEdit ? (
          <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-xl hover:bg-slate-100 text-slate-600">
            <PencilSimple className="h-4 w-4 text-[#ee7f03]" />
          </Button>
        ) : (
          <motion.button
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="px-8 pb-8 flex-1 overflow-y-auto space-y-8 scrollbar-hide">
              ...
              {needsMotifCdd && (
                <div>
                  ...
                  <Textarea
                    ...
                    className="rounded-xl bg-white border-slate-200 min-h-[75px] focus-visible:ring-[#ee7f03]"
                  />
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="rounded-xl bg-white border-slate-200 min-h-[85px] focus-visible:ring-[#ee7f03]"
                />
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="rounded-xl bg-white border-slate-200 min-h-[65px] focus-visible:ring-[#ee7f03]"
                />
              </div>
              ...
              <div className="flex flex-col gap-3 p-4 rounded-xl bg-slate-50 border border-slate-100">
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input
                    ...
                    className="h-4 w-4 rounded-md border-slate-300 accent-[#ee7f03]"
                  />
            ...
            <DialogFooter className="pt-4 sticky bottom-0 bg-white -mx-8 px-8 mt-4 border-t border-slate-100 shrink-0">
              <Button
                ...
                className="w-full h-12 rounded-2xl bg-[#ee7f03] hover:bg-[#d67002] text-white font-bold shadow-lg shadow-[#ee7f03]/20 transition-all hover:scale-[1.01] active:scale-[0.99]"
              >
                {isSubmitting
