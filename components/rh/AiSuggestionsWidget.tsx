  ...
  return (
    <div className="rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm p-5 transition-all">
      ...
      <div className="flex items-center gap-2.5 mb-4">
        <div className="h-8 w-8 rounded-lg flex items-center justify-center shrink-0 bg-[#ee7f03]/10 text-[#ee7f03]">
      ...
      {loading && (
        <div className="flex items-center gap-2.5 py-6 justify-center">
          <SpinnerGap
            size={18}
            className="animate-spin text-[#ee7f03]"
          />
          ...
          {suggestions.map((s) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  href={s.href}
                  className="inline-flex items-center gap-1 text-[11px] font-semibold text-[#ee7f03] hover:text-[#d67002] hover:underline transition-all self-start group pt-1"
                >
                  Agir
                  <ArrowRight
                    size={12}
