...
export function GuidedWorkflowWorkspace({
  ...
  const WORKFLOW_META = {
    ...
    paie: {
      ...
      icon: Calculator,
      color: "text-[#ee7f03]",
      bgColor: "bg-[#ee7f03]/10 border-[#ee7f03]/30",
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded-full bg-[#ee7f03]/10 text-[#ee7f03] text-[10px] font-bold uppercase tracking-wider border border-[#ee7f03]/20">
                    Workflow Guidé RH
                  </span>
                ...
                <React.Fragment key={step.num}>
                  ...
                  >
                    <div className={`h-9 w-9 rounded-xl flex items-center justify-center text-xs font-bold transition-all ${
                      isActive 
                        ? "bg-[#ee7f03] text-white shadow-lg shadow-[#ee7f03]/30 ring-4 ring-[#ee7f03]/20 scale-105" 
                        : isPassed 
                    ...
                    <div className="hidden sm:block">
                      <p className={`text-xs font-bold leading-none ${isActive ? "text-[#ee7f03]" : isPassed ? "text-emerald-600 dark:text-emerald-400" : "text-slate-400"}`}>
                        {step.label}
                      </p>
                    ...
                    {[
                      ...
                      >
                        <input
                          ...
                          className="h-4 w-4 rounded border-slate-300 text-[#ee7f03] focus:ring-[#ee7f03]"
                        />
              ...
              {currentStep === 2 && (
                <div className="space-y-4 text-center py-4">
                  <div className="max-w-md mx-auto bg-slate-50 dark:bg-slate-800/60 p-6 rounded-3xl border border-slate-200 dark:border-slate-700">
                    <UserPlus className="h-10 w-10 text-[#ee7f03] mx-auto mb-3" />
                    ...
                    <Button 
                      ...
                      className="bg-[#ee7f03] hover:bg-[#d67002] text-white font-bold text-xs px-6 py-2.5 rounded-xl shadow-md shadow-[#ee7f03]/20 w-full"
                    >
              ...
              {currentStep === 3 && (
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-50 dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700">
                    <div className="flex items-center gap-3">
                      <FileText className="h-6 w-6 text-[#ee7f03]" />
                      <div>
                            ...
                            {[
                              ...
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                                  decision === btn.id
                                    ? "bg-[#ee7f03] text-white shadow-md shadow-[#ee7f03]/20"
              ...
              {currentStep === 3 && (
                <div className="space-y-4">
                  ...
                  <Button 
                    ...
                    className="w-full bg-[#ee7f03] text-white font-bold text-xs py-3 rounded-xl"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800/40 space-y-2">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-center text-xs">
                      ...
                      <div className="p-2 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800">
                        <span className="block font-bold text-[#ee7f03]">20h</span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <Button 
                      ...
                      className="bg-[#ee7f03] text-white font-bold text-xs py-2.5 rounded-xl flex items-center justify-center gap-2"
                    >
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex items-center justify-between gap-3">
          ...
          {currentStep < 3 ? (
            <Button
              ...
              className="bg-[#ee7f03] hover:bg-[#d67002] text-white font-bold text-xs px-6 py-2 rounded-xl shadow-md shadow-[#ee7f03]/20 flex items-center gap-2"
            >
