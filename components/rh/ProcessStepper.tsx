          ...
          return (
            <li key={step.href} className="flex shrink-0 items-center">
              <Link
                ...
                className={cn(
                  "group flex items-center gap-2 rounded-xl px-2.5 py-1.5 text-[13px] font-medium outline-none transition-colors focus-visible:ring-2 focus-visible:ring-[#f6c68a]",
                  status === "current" &&
                    "bg-[#ee7f03]/10 text-[#ee7f03] dark:bg-[#ee7f03]/10 dark:text-[#f8d3a3]",
                  status === "done" &&
              ...
              >
                <span
                  className={cn(
                    ...
                    status === "current" && "bg-[#ee7f03] text-white",
