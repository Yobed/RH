  ...
  return (
    <div className="flex h-[750px] flex-col rounded-3xl border border-slate-200/60 bg-slate-50/30 overflow-hidden backdrop-blur-xl shadow-2xl relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
        ...
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-blue-400/20 rounded-full blur-[100px] animate-pulse [animation-delay:2s]" />
      </div>
      ...
      <div className="px-6 py-4 border-b border-white/40 bg-white/40 flex items-center justify-between backdrop-blur-md relative z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <Badge variant="outline" className="bg-white/50 border-slate-200 text-slate-600 font-medium py-1 px-2.5">
            <ShieldCheck className="h-3 w-3 mr-1.5 text-blue-500" />
            Conformité IA
          </Badge>
        </div>
      </div>
          ...
          {messages.length === 0 ? (
            ...
            >
              <div className="relative">
                ...
                <div className="relative h-20 w-20 rounded-2xl bg-gradient-to-br from-primary to-indigo-600 flex items-center justify-center shadow-2xl">
      ...
      <div className="p-6 pt-0 relative z-10">
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-primary/50 to-indigo-500/50 rounded-[24px] blur opacity-0 group-focus-within:opacity-30 transition duration-500" />
