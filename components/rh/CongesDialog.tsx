...
import { SearchableEmployeeSelect } from "@/components/rh/SearchableEmployeeSelect";
import type { Tables } from "@/types/supabase";

type Employee = Pick<Tables<"employees">, "id" | "full_name" | "matricule"> & { photo_url?: string | null };
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button className="inline-flex items-center justify-center rounded-2xl bg-[#ee7f03] px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-[#ee7f03]/20 hover:bg-[#d67002] transition-all duration-200 gap-2">
          ...
          <form id="conges-form" onSubmit={handleSubmit(onSubmit)} className="px-8 pb-8 flex-1 overflow-y-auto space-y-6 scrollbar-hide">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <Input
                  type="date"
                  {...register("date_debut")}
                  className="h-11 rounded-xl border-slate-200 focus-visible:ring-[#ee7f03] focus-visible:border-[#ee7f03]"
                  onChange={(e) => {
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <Input type="number" min="0.5" step="0.5" {...register("nb_jours")} className="h-11 rounded-xl border-slate-200 focus-visible:ring-[#ee7f03] focus-visible:border-[#ee7f03]" />
                {errors.nb_jours && (
              ...
              <div className="space-y-1.5">
                ...
                <Input type="date" {...register("date_reprise")} className="h-11 rounded-xl border-slate-200 focus-visible:ring-[#ee7f03] focus-visible:border-[#ee7f03]" />
            ...
            <label className="flex items-center gap-3 cursor-pointer select-none py-1">
              <input type="checkbox" {...register("conge_fractionne")} className="h-4 w-4 rounded border-slate-300 accent-[#ee7f03] focus:ring-[#ee7f03]" />
            ...
            {needsJustificatif && (
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="cursor-pointer file:cursor-pointer file:bg-[#ee7f03]/10 file:text-[#ee7f03] file:border-none file:rounded-lg file:px-3 file:py-1 file:mr-3 h-12 bg-slate-50/50 border-dashed border-2 border-slate-200 hover:border-[#ee7f03]/40 transition-all pt-2 rounded-xl"
                />
                {fileError ? (
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                className="min-h-[80px] resize-none rounded-xl border-slate-200 focus-visible:ring-[#ee7f03] focus-visible:border-[#ee7f03]"
              />
            </div>
            ...
            <DialogFooter className="pt-4 sticky bottom-0 bg-white -mx-8 px-8 mt-6 border-t border-slate-100 flex items-center justify-end gap-3">
              ...
              <Button 
                ...
                form="conges-form" 
                disabled={isSubmitting} 
                className="h-11 rounded-2xl bg-[#ee7f03] hover:bg-[#d67002] text-white font-bold px-6 shadow-lg shadow-[#ee7f03]/20 transition-all hover:scale-[1.01] active:scale-[0.99]"
              >
