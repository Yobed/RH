...
- [x] **Phase 8: Import Paie Sage** — Importation du Livre de Paie Sage avec template de mapping, traitement Python et traçabilité dans payroll_logs
...
- [x] 03-03-PLAN.md — Page /conges/calendrier — grille mensuelle par employé avec filtre département
- [x] 03-04-PLAN.md — calculerRetenuAbsence dans lib/paie-ci.ts + champ absence PaieDialog + preview retenue
- [x] 03-05-PLAN.md — ArretMaladieDialog avec upload justificatif + colonnes est_justifie/est_at + badges liste congés
...
- [x] 08-02-PLAN.md — API routes GET template + POST import (validation + insert payroll_logs)
- [x] 08-03-PLAN.md — Page /paie/import-sage + SageImportDropzone + entree SidebarNav
...
| 2. Paie Avancée | 5/5 | Completed | 15 avril 2026 |
| 3. Congés & Absences | 4/5 | In Progress|  |
...
| 8. Import Paie Sage | 3/3 | Completed | 27 avril 2026 |
...
| ISP-01 | Phase 8 | Completed |
| ISP-02 | Phase 8 | Completed |
| ISP-03 | Phase 8 | Completed |
| ISP-04 | Phase 8 | Completed |
| ISP-05 | Phase 8 | Completed |
