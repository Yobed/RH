  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      ...
      <nav className="flex items-center gap-1.5 text-sm text-slate-500">
        <Link href="/ged" className="flex items-center gap-1.5 hover:text-[#ee7f03] transition-colors font-medium">
      ...
      <div className="rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
        <div className="h-2 bg-gradient-to-r from-[#ee7f03] to-[#ee7f03]" />
        <div className="p-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start gap-4">
            {/* Avatar */}
            <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-[#ee7f03] to-[#ee7f03] flex items-center justify-center text-white font-bold text-lg shadow-sm shrink-0">
              {(() => {
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                ...
                {employee.type_contrat && (
                  <span className="inline-flex items-center rounded-full bg-[#ee7f03]/10 px-2.5 py-0.5 text-[10px] font-semibold text-[#ee7f03]">
                    {employee.type_contrat}
                  </span>
                )}
