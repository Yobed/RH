...
import { AnalytiqueFocus } from "./AnalytiqueFocus";

export const metadata = {
  title: "Focus Analytique Expert | RH Manager CI",
  description: "Vue segmentée et pilotage stratégique des indicateurs RH",
};
        ...
        fallback={
          <div className="rounded-2xl border border-slate-100 bg-white shadow-[0_2px_12px_-2px_rgba(0,0,0,0.04)] p-16 flex items-center justify-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-slate-600 font-medium">Initialisation du cockpit expert...</p>
            </div>
          </div>
        }
      >
