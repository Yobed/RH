...
const SEVERITY_COLORS: Record<Severity, { bg: string; text: string; border: string; dot: string }> = {
  ...
  info:     { bg: "bg-[#ee7f03]/10",   text: "text-[#ee7f03]",   border: "border-[#ee7f03]/30",   dot: "bg-[#ee7f03]" },
};
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <form method="GET" className="flex items-center gap-2">
          ...
          <input
            ...
            className="rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-sm shadow-sm focus:border-[#f6c68a] focus:outline-none focus:ring-2 focus:ring-[#ee7f03]/15"
          />
          <button
            type="submit"
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            <Link
                              ...
                              className="font-semibold text-slate-800 hover:text-[#ee7f03] transition-colors"
                            >
                              {a.fullName}
                            </Link>
