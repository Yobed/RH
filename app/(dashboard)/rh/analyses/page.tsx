    ...
    <div className="p-6 space-y-8 max-w-7xl mx-auto">
      <div className="flex items-start justify-between gap-4 pb-5 border-b border-slate-100">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5 font-medium">Visualisez et maîtrisez votre masse salariale en temps réel</p>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          ...
          <span className="inline-flex items-center rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-widest border border-slate-200 text-slate-500 bg-white">
            Live
          </span>
        </div>
      </div>
      ...
      {!employees || employees.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate-200 p-12 text-center">
          <p className="text-sm font-medium text-slate-500">Aucune donnée disponible</p>
      ...
      <div className="rounded-xl bg-slate-50 border border-slate-100 p-6">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-4">Lexique des indicateurs</p>
