...
const COLUMNS = [
  ...
  { header: "sursalaire", example: "50000" },
  { header: "prime_transport", example: "30000" },
  { header: "nb_enfants", example: "2" },
  { header: "nationalite", example: "Ivoirienne" },
  { header: "etat_civil", example: "Marié(e)" },
...
export async function GET() {
  ...
  const legend = [
    ...
    ["sursalaire", "Sursalaire mensuel (FCFA)", "Nombre entier", "Non"],
    ["prime_transport", "Prime de transport mensuelle (FCFA)", "Nombre entier", "Non"],
    ["nb_enfants", "Nombre d'enfants à charge", "Nombre entier", "Non"],
    ["nationalite", "Nationalité", "Texte libre", "Non"],
    ["etat_civil", "État civil", "Célibataire, Marié(e), Divorcé(e), Veuf/Veuve", "Non"],
